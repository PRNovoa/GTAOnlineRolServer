...
Config.WeedPrice = 360	-- sell price for single, not pooch (black money)   //   PRECIO GRAMO: 9
Config.MethPrice = 340	-- sell price for single, not pooch (black money)   //   PRECIO GRAMO: 34
Config.CokePrice = 375	-- sell price for single, not pooch (black money)   //   PRECIO GRAMO: 75
Config.OpiuPrice = 360	-- sell price for single, not pooch (black money)   //   PRECIO GRAMO: 30
