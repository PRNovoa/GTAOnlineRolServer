...
Banks = {
	["fleeca"] = {
		...
		reward = math.random(150000,250000), -- the random range of amount of money you will get for robbery this site
		nameofbank = "Sucursal BBVA", --Visual Name that will be the site
		lastrobbed = 0, -- DONT TOUCH THIS variable used to make a delay to robb other time
		doortype = 2121050683,--'V_ILEV_GB_VAULDR' -- Name or ID of the gameobject that will be rotate to make the open efect, you can check what id or name you need here: https://objects.gt-mp.net/ if you dont find it, contact with you developer, he will know how to get it in game
	},
	["fleeca2"] = {
		...
		nameofbank = "Sucursal BBVA (Autopista)",
		lastrobbed = 0,
		doortype = -63539571,--'hei_prop_heist_sec_door'
	},
	--[[["blainecounty"] = {
	...
	["PrincipalBank"] = {
		...
		reward = math.random(30000000,50000000),
		nameofbank = "Banco Central del BBVA",
		lastrobbed = 0,
        bombdoortype = 961976194,--'v_ilev_bk_vaultdoor', -- If this var is set you will need set the var "bombposition" to work properly , you can find the name or id here: https://objects.gt-mp.net/  if you dont find it, contact with your devs
