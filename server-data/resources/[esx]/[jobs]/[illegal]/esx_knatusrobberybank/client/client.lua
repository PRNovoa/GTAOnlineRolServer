...
AddEventHandler('esx_holdupbank:plantedbomb', function(x,y,z,doortype)
	...
	-- print(z)
	-- print(doortype)
	-- local obs, distance = ESX.Game.GetClosestObject(coords, doortype)
	local obs = GetClosestObjectOfType(x, y, z, 5.0, doortype, false)
	-- print(GetEntityHeading(obs))
	-- print(distance)
    --AddExplosion( bank.bombposition.x,  bank.bombposition.y, bank.bombposition.z , 0, 0.5, 1, 0, 1065353216, 0)
    AddExplosion( x-2.0, y, z+0.5 , 4, 1.0, 1, 0, 1065353216, 0, false)
    AddExplosion( x-2.0, y, z+0.5 , 4, 1.0, 1, 0, 1065353216, 0, false)
   -- AddExplosion( bank.bombposition.x,  bank.bombposition.y, bank.bombposition.z , 0, 0.5, 1, 0, 1065353216, 0)
...
Citizen.CreateThread(function()
    while true do
        FreezeEntityPosition(GetClosestObjectOfType(261.89, 221.8, 106.28, 5.0, GetHashKey('hei_v_ilev_bk_gate2_pris'), false), true)
		Wait(2000)
	end
end)
