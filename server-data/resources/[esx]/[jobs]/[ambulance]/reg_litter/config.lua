...
Config              = {}
Config.OpenMenuSpawn= {x = 318.91, y = -589.14, z = 43.28}
...
Config.Language = {
	...
	lit_2 = "Green matela bed",
	lit_3 = "Blue matela bed",
	anim = {
		spawn_command = "civiere",
		lie_back = "Lie on your back",
		sit_right = "Sit to the right of the table",
		sit_left = "Sit on the left of the table",
		convulse = "Convulse",
		pls = "Be in pls",
	}
}