...
local zones = {
	-- Garajes
	{ ['x'] = 238.5, ['y'] = -771.05, ['z'] = 29.67, ['radius'] = 50.0 },
	{ ['x'] = -1533.1, ['y'] = -432.0, ['z'] = 34.44, ['radius'] = 27.5 },
	-- Comisarias
	{ ['x'] = 454.1, ['y'] = -1002.5, ['z'] = 28.0, ['radius'] = 41.0 },
	-- Hospitales



	-- ------
	{ ['x'] = 1847.916015625, ['y'] = 3675.8190917968, ['z'] = 33.767009735108, ['radius'] = 50.0} ,
	{ ['x'] = -1688.43811035156, ['y'] = -1073.62536621094, ['z'] = 13.1521873474121, ['radius'] = 50.0 },
	{ ['x'] = -2195.1352539063, ['y'] = 4288.7290039063, ['z'] = 49.173923492432, ['radius'] = 50.0 }
}
...
Citizen.CreateThread(function()
	...
	while true do
		...
		local saferadius = zones[closestZone].radius
	
		if dist <= saferadius then  ------------------------------------------------------------------------------ Here you can change the RADIUS of the Safe Zone. Remember, whatever you put here will DOUBLE because 
		...
		if notifIn then
			...
			DisableControlAction(2, 140, true) -- disable R hit
			if IsDisabledControlJustPressed(2, 37) then --if Tab is pressed, send error message
				...
				TriggerEvent("pNotify:SendNotification",{
					text = "<b style='color:#1E90FF'>No puedes usar/sacar armas en Zona Segura</b>",
					type = "error",
					timeout = (3000),
					layout = "bottomcenter",
					queue = "global"
			...
			if IsDisabledControlJustPressed(0, 106) then --if LeftClick is pressed, send error message
				...
				TriggerEvent("pNotify:SendNotification",{
					text = "<b style='color:#1E90FF'>No puede hacer eso en Zona Segura</b>",
					type = "error",
					timeout = (3000),
					layout = "bottomcenter",
					queue = "global"
		...
		-- Comment out lines 142 - 145 if you dont want a marker.
	 	if DoesEntityExist(player) then	      --The -1.0001 will place it on the ground flush		-- SIZING CIRCLE |  x    y    z | R   G    B   alpha| *more alpha more transparent*
	 		-- DrawMarker(1, zones[closestZone].x, zones[closestZone].y, zones[closestZone].z-1.0001, 0, 0, 0, 0, 0, 0, zones[closestZone].radius*2, zones[closestZone].radius*2, 2.0, 13, 232, 255, 155, 0, 0, 2, 0, 0, 0, 0) -- heres what all these numbers are. Honestly you dont really need to mess with any other than what isnt 0.
