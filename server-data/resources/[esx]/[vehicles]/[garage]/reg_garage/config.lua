Config = {}
Config.Blip			= {sprite= 357, color = 27, scale = 0.8}
Config.BoatBlip		= {sprite= 356, color = 60, scale = 0.8}
Config.AirplaneBlip	= {sprite= 359, color = 60, scale = 0.8}
Config.MecanoBlip	= {sprite= 357, color = 60, scale = 0.8}
...
Config.Garages = {
	Garage_Centre = {
		Pos = {x=215.800, y=-810.057, z=30.797},
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = _U('garage_name'),
		HelpPrompt = _U('open_car_garage'),
		SpawnPoint = {
			Pos = {x=229.700, y= -800.1149, z= 30.6},
			Heading = 160.0,
