...
window.onload = function () {
		...
		var eventCallback = {
			ui: function(data) {
				...
				if (config.showSociety2Money == true) { document.querySelector('#society2').style.display = 'block'; } // Secondary/Mafia jobs
				...
				if (config.showJob2 == true) { document.querySelector('#job2').style.display = 'block'; } // Secondary/Mafia jobs
